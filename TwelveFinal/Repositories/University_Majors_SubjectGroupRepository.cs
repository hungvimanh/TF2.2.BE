...
namespace TwelveFinal.Repositories
{
    ...
    public class University_Majors_SubjectGroupRepository : IUniversity_Majors_SubjectGroupRepository
    {
        ...
        public University_Majors_SubjectGroupRepository(TFContext _tFContext)
        {
        ...
        {
            IQueryable<University_Majors_SubjectGroupDAO> university_Majors_SubjectGroupDAOs = tFContext.University_Majors_SubjectGroup;
        ...
        {
            University_Majors_SubjectGroup university_Majors_SubjectGroup = await tFContext.University_Majors_SubjectGroup.Where(u => u.Id == Id).Select(u => new University_Majors_SubjectGroup
            {
                Id = u.Id,
